        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 p-10 bg-white shadow-xl rounded-2xl">
                <div className="text-center">
                    <h2 className="text-3xl font-extrabold font-serif text-primary-text">Welcome Back!</h2>
                    <p className="mt-2 text-sm text-secondary-text">
                        Sign in to continue to Fork & Fire.
                    </p>
                </div>
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-sm">
                            <Link to="/forgot-password" className="font-medium text-accent hover:text-accent/80 transition-colors">
                ...
                <div className="text-sm text-center text-secondary-text">
                    <p>
                        New to Fork & Fire?{' '}
                        <Link to="/signup" state={{ from: location.state?.from }} className="font-medium text-accent hover:underline">
                            Create an account
                        </Link>
                    </p>
                </div>
